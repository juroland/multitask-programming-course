...
sem_t count_prime_semaphore;

void* count_prime(void *arg)
{
    sem_wait(&count_prime_semaphore);
    ...
    sem_post(&count_prime_semaphore);

    int sval = 0;
    sem_getvalue(&count_prime_semaphore, &sval);
...
int main(int argc, char** argv)
{
    ...
    sem_init(&count_prime_semaphore, 0, 2);
    ...
    sem_destroy(&count_prime_semaphore);
